...
namespace Microsoft.Azure.Management.Sql
{
    ...
    public static partial class JobExecutionsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<JobExecution> ListByAgent(this IJobExecutionsOperations operations, string resourceGroupName, string serverName, string jobAgentName, string skip = default(string))
            {
                return operations.ListByAgentAsync(resourceGroupName, serverName, jobAgentName, skip).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<IPage<JobExecution>> ListByAgentAsync(this IJobExecutionsOperations operations, string resourceGroupName, string serverName, string jobAgentName, string skip = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListByAgentWithHttpMessagesAsync(resourceGroupName, serverName, jobAgentName, skip, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The number of elements in the collection to skip.
            /// </param>
            public static IPage<JobExecution> ListByJob(this IJobExecutionsOperations operations, string resourceGroupName, string serverName, string jobAgentName, string jobName, string skip = default(string))
            {
                return operations.ListByJobAsync(resourceGroupName, serverName, jobAgentName, jobName, skip).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<JobExecution>> ListByJobAsync(this IJobExecutionsOperations operations, string resourceGroupName, string serverName, string jobAgentName, string jobName, string skip = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListByJobWithHttpMessagesAsync(resourceGroupName, serverName, jobAgentName, jobName, skip, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
