...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class JobAgent : TrackedResource
    {
        ...
        public JobAgent(string location, string databaseId, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
