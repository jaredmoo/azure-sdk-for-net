...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ElasticPool : TrackedResource
    {
        ...
        /// Price'</param>
        public ElasticPool(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), string state = default(string), System.DateTime? creationDate = default(System.DateTime?), int? maxSizeInMB = default(int?), ElasticPoolPerDatabaseSettings perDatabaseSettings = default(ElasticPoolPerDatabaseSettings), bool? zoneRedundant = default(bool?), string licenseType = default(string))
