...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class UpgradeRecommendedElasticPoolProperties
    {
        ...
        public UpgradeRecommendedElasticPoolProperties(string name = default(string), string edition = default(string), int? dtu = default(int?), int? storageMb = default(int?), int? databaseDtuMin = default(int?), int? databaseDtuMax = default(int?), System.Collections.Generic.IList<string> databaseCollection = default(System.Collections.Generic.IList<string>), bool? includeAllDatabases = default(bool?))
        {
            Name = name;
            Edition = edition;
            Dtu = dtu;
